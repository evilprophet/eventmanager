        ...
        <div class="panel panel-default">
            <div class="panel-heading clearfix">
                ...
                <a class="btn btn-default btn-lg pull-right" data-dismiss="modal" aria-label="Close"
                   href=<c:url value='/admin/reservations'/>>Back</a>
            </div>
            <div class="panel-body">
                <form class="form-horizontal">
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <p class="form-control-static">
                                ...
                                <a class="btn btn-info btn-xs" data-dismiss="modal" aria-label="Close"
                                   href=<c:url value='/admin/events/${reservation.event.id}'/>>Details</a>
                            </p>
                        </div>
                        ...
                        <div class="col-sm-10">
                            <p class="form-control-static">${reservation.uuid}</p>
                        </div>
                        <label class="col-sm-2 control-label">Reservation Key</label>
                        <div class="col-sm-10">
                            <p class="form-control-static">${reservation.reservationKey}</p>
                        </div>
                    </div>
                </form>
            </div>
